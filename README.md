...
The favicon is the logo-type icon which appears in browser bars and in the tabs of browser windows next to the Web page name. But I get it—-you're not drinking the Kool Aid! No problem, it's not required and may be removed by:
...
##Linking Your Vitae to a Google Doc
By embedding a Google Doc in the **Vitae** page, you may make edits directly to your vitae (qua Google Doc) which will be reflected in the Website in real time. To point the iframe on the **Vitae.html** to __your own__ Google Doc, then, do the following:
