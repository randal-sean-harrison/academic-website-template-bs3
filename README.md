...
The favicon is the 'favorite' icon which appears in browser bars and the tabs of browser windows. It is not required and my be removed by:
...
To create your own favicon, visit [Favicon Generator](https://community.algolia.com/docsearch/) and upload your own image to generate the favicons. Next, simply replace the entire contents of this **Favicons/** folder with the files generated by the Favicons Generator site.
