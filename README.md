...
The favicon is not required. To create your own favicon, visit [FaviconGenerator.org](https://community.algolia.com/docsearch/)https://www.favicon-generator.org/) and upload your own image to generate the favicons. Next, simply delete the entire contents of the **Favicons/** folder and replace it with the files generated by the site.
