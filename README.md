...
The favicon is the logo-type icon which appears in browser bars and in the tabs of browser windows next to the Web page name. It is not required and may be removed by:
...
To create your own favicon, visit [Favicon Generator](https://www.favicon-generator.org/) and upload your own image to generate your favicon files. Next, download the favicon files. Finally, simply replace the entire contents of your local **Favicons/** folder with the files generated by the Favicons Generator site.

##Linking Your Vitae to a Google Doc
By embedding a Google Doc in the **Vitae** page, you may make edits directly to your vitae (qua Google Doc) which will be reflected in the Website in real time. To point, the iframe on the **Vitae.html** to your own Google Doc, do the following:

1. look for the following code on line 109:
...
```
2. Replace **1_AJVKpKeyh_NFvlKA6nOT7GbR8NuFfJjQn-5tIumWpY** with your own unique Google Doc ID. This can be copied from the browser's URL bar once inside the Google Doc.
